...
def load_model(ckpt_pth=None):
    ...
    for name, param in model.named_parameters():
        if param.requires_grad and name.split('.')[0] == 'encoder':
...
#             torch.nn.ReLU(),
#         )
#         self.conv16 = torch.nn.Sequential(
#             torch.nn.BatchNorm1d(128),
#             ConvNorm(in_channels=128, out_channels=128, kernel_size=3),
#             torch.nn.ReLU(),
#             ConvNorm(in_channels=128, out_channels=128, kernel_size=3),
#             torch.nn.ReLU(),
#         )
#         self.conv17 = torch.nn.Sequential(
#             torch.nn.BatchNorm1d(128),
#             ConvNorm(in_channels=128, out_channels=128, kernel_size=3),
#             torch.nn.ReLU(),
#             ConvNorm(in_channels=128, out_channels=128, kernel_size=3),
#             torch.nn.ReLU(),
#         )
#         self.conv18 = torch.nn.Sequential(
#             torch.nn.BatchNorm1d(128),
#             ConvNorm(in_channels=128, out_channels=128, kernel_size=3),
#             torch.nn.ReLU(),
#             ConvNorm(in_channels=128, out_channels=128, kernel_size=3),
#             torch.nn.ReLU(),
#         )
#         self.conv19 = torch.nn.Sequential(
#             torch.nn.BatchNorm1d(128),
#             ConvNorm(in_channels=128, out_channels=128, kernel_size=3),
#             torch.nn.ReLU(),
#             ConvNorm(in_channels=128, out_channels=128, kernel_size=3),
...
#             ConvNorm(in_channels=128, out_channels=64, kernel_size=3),
#             torch.nn.ReLU(),
#             ConvNorm(in_channels=64, out_channels=64, kernel_size=3),
#             torch.nn.ReLU(),
#         )
...
#             torch.nn.ReLU(),
#         )
#         self.conv25 = torch.nn.Sequential(
#             torch.nn.BatchNorm1d(64),
#             ConvNorm(in_channels=64, out_channels=64, kernel_size=3),
#             torch.nn.ReLU(),
#             ConvNorm(in_channels=64, out_channels=32, kernel_size=3),
#             torch.nn.ReLU(),
#         )
