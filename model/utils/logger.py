...
class MercuryNetLogger(SummaryWriter):
    def __init__(self, logdir):
        super(MercuryNetLogger, self).__init__(logdir, flush_secs=5)
    ...
    def log_training_vid(
        self, output, target, reduced_loss, grad_norm, learning_rate, iteration
    ):
        ...
        self.add_image("alignment", plot_alignment_to_numpy(alignments), iteration)
        self.add_image("mel_outputs", plot_spectrogram_to_numpy(mel_outputs), iteration)
        self.add_image(
            "mel_outputs_postnet",
            plot_spectrogram_to_numpy(mel_outputs_postnet),
            iteration,
        )
        self.add_image("mel_target", plot_spectrogram_to_numpy(mel_target), iteration)
    ...
    def sample_training(self, output, target, iteration):
        ...
        # plot alignment, mel and postnet output
        self.add_image("alignment_test", plot_alignment_to_numpy(alignments), iteration)
        self.add_image(
            "mel_outputs_test", plot_spectrogram_to_numpy(mel_outputs), iteration
        )
        self.add_image(
        ...
        self.add_image(
            "mel_target_test", plot_spectrogram_to_numpy(mel_target), iteration
        )
